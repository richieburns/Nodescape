...
This mechanism has been integrated into Bitcore-Node-Nodescape which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/nodescapepay/insight-api-nodescape#web-socket-api](https://github.com/nodescapepay/insight-api-nodescape#web-socket-api)
* API: [https://github.com/nodescapepay/insight-api-nodescape#instantsend-transactions](https://github.com/nodescapepay/insight-api-nodescape#instantsend-transactions)
...
By default, the Nodescape Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Nodescape Core daemon:
