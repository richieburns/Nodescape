...
Nodescape Core is a multithreaded application, and deadlocks or other multithreading bugs
...
However, in open source software such as Nodescape Core, where everyone uses
...
pay attention to for reviewers of Nodescape Core code.

General Nodescape Core
----------------------
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: Nodescape Core uses tinyformat, which is type safe. Leave them out to avoid confusion
