...
Only requiring some minor changes is nodescape.cpp.
...
Changes to nodescape.cpp
----------------------
nodescape.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
