...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("Nodescape Core nodescape-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  nodescape-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded nodescape transaction") + "\n" +
              "  nodescape-tx [options] -create [commands]   " + _("Create hex-encoded nodescape transaction") + "\n" +
              "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded nodescape transaction
