...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "NodescapeNetwork") type = NodescapeNetwork;
    if(strType == "NodescapeNetworkVariable") type = NodescapeNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == NodescapeNetwork) s = "NodescapeNetwork";
    if(type == NodescapeNetworkVariable) s = "NodescapeNetworkVariable";
