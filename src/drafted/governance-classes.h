 ...
 *
 *   // network
 *   CNodescapeNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.nodescape.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CNodescapeNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
public:
    CNodescapeNetwork(UniValue objIn)
    {
...
// // can be under: NodescapeNetwork
// //   -- signature requirements : Key1(User)
// class CNodescapeNetworkVariable : public CGovernanceObject
// {
// private:
...
//     //     return (IsType() == NodescapeNetwork);
//     // }
