...
#define BOOST_TEST_MODULE Nodescape Test Suite

#include "test_nodescape.h"
...
#endif
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_nodescape_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
