    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Nodescape Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        ...
        QString header = tr("Usage:") + "\n" +
            "  nodescape-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Nodescape in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 NSX, 0.1 NSX, 1 NSX and 10 NSX -- sort of like the paper money you use every day.</li> \
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Nodescape Core is shutting down...") + "<br /><br />" +
