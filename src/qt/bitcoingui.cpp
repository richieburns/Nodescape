    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Nodescape Core") + " - ";
#ifdef ENABLE_WALLET
    ...
    progressBarLabel->setStyleSheet("QLabel { margin-right:1em; margin-left:1em;}");
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Nodescape address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and nodescape: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Nodescape Core"), this);
    aboutAction->setStatusTip(tr("Show information about Nodescape Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Nodescape Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Nodescape addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Nodescape addresses"));
    ...
    openAction->setStatusTip(tr("Open a nodescape: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Nodescape Core help message to get a list with possible Nodescape Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Nodescape Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Nodescape network", "", count));
    } else {
...
{
    QString strTitle = tr("Nodescape Core"); // default title
    ...
    // Append title to "Nodescape Core - "
    if (!msgType.isEmpty())
        strTitle += " - " + msgType;
